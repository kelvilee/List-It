...
class ViewController: UITableViewController {
    ...
    {
        // index of the new item will be the current item count
        let newIndex = todoItems.count
    
        // Create new item and add to todo list
    ...
    @objc
    public func applicationDidEnterBackground(_ notidication: NSNotification)
    {
        do
        {
    ...
    override func viewDidLoad() {
        ...
        catch let error as NSError
        {
            ...
            {
                NSLog("No persistence file found, not necessarilly and error")
            }
            else
            {
